                  ...
                  <Games2Line>
                    {sortedGames
                      ...
                      ?.map((game, index) => {
                        ...
                        let lastUnlocked =
                          allUnlocked?.[allUnlocked?.length - 1];

                        let isPlatinumNotAdded =
                  ...
                  <Games2LineCDL>
                    {sortedGames?.map((game, index) => {
                      ...
                      return (
                        ...
                        >
                          <GameInfoCDOuter>
                            <GameCdImage game={game} scale={1.1} />
                            <span
                              style={{
                                marginBottom: "1rem",
                                marginTop: "1rem",
...
const GameInfoCDOuter = styled.div`
  display: flex;
  flex: 2;
  align-items: center;
  justify-content: flex-end;
